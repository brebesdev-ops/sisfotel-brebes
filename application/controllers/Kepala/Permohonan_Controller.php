...
class Permohonan_Controller extends CI_Controller
{
	...
	public function index()
	{
			...
			$x['kepala'] = $this->db->get_where('auth', ['id' => $this->session->userdata('id')])->row_array();
	...
	public function edit_kepala($id)
	{	

				// print_r($_POST); die();

		$id					= $this->input->post('id');
		$is_approve_kepala               = $this->input->post('nama');
	...
	public function update_kepala()
	{

				// print_r($_POST); die();

		$id					= $this->input->post('id');
		$is_approve_kepala      = $this->input->post('is_approve_kepala');

	   
		$data = array(
			'is_approve_kepala'				=> $is_approve_kepala
		);
		...
		$this->M_Permohonan->update_data('tb_permohonan',$data, $where);
		redirect('kepala/permohonan/detail/'.$id);     
	}
	public function update_kepala_tolak()
	{
