				...
				<div class="section-body">
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									<?php 													foreach($survey as $permohonans){ ?>

									<form method="post" action="<?php echo site_url('kasi/survey/update') ?>"
										...
										<div class="form-group row mb-4">
											...
											<div class="col-sm-12 col-md-7">
												<input type="date" class="form-control" name="tanggal_survey" value="<?= $permohonans->tanggal_survey ?>"
										...
										<div class="form-group row mb-4">
											...
											<div class="col-sm-12 col-md-7">
												<input type="text" class="form-control" name="nomor" value="<?= $permohonans->nomor ?>"
