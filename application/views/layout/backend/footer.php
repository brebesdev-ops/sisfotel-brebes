			<footer class="main-footer">
				<div class="footer-left">
					Copyright &copy; 2020 <div class="bullet"></div> DINKOMINFOTIK BREBES
				</div>
			</footer>
		</div>
	</div>
	...
	<!-- JS Libraies -->
	<script src="<?= base_url('')?>assets/backend/modules/simpleweather/jquery.simpleWeather.min.js"></script>
