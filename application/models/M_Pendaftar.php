...
class M_Pendaftar extends CI_Model {
	...
	public function check_pendaftar($email, $password)
	{
		$this->db->select('*');
	...
	public function get_data($id = NULL)
    {
 	...
 	// ------------------------------------------------------------------------
  	...
  	// ------------------------------------------------------------------------
  	public function insert_data($provider_data,$table)
    {
		$this->db->insert($table,$provider_data);
    }
	// ------------------------------------------------------------------------
...
// {
//      $this->db->update('tb_pendaftar', $data, array('id' => $where));
